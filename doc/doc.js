    ...
    $(document).ready(function(){
        ...
        var build_grid = function(){
            ...
            if( $grid.hasClass('grid-x') ){
                ...
                var col = parseInt($grid.data('column'), 1);
                var gut = parseInt($grid.data('size-gutter'), 10);
                gut = gut%2==0 ? gut : parseInt(gut/2, 10)*2;
        ...
        $('#b_build').on('click', function(){
            ...
            if( layout=='x' ){
                ...
                attrs += ' data-size-width="'+parseInt($('#b_size_w').val(), 10)+'"';
                attrs += ' data-size-height="'+parseInt($('#b_size_h').val(), 10)+'"';
                attrs += ' data-open-state="'+$('#b_open_x').val()+'"';
                attrs += ' data-size-gutter="'+parseInt($('#b_gutter').val(), 10)+'"';
            }
